...
<a href="https://www.facebook.com/profile.php?id=61565638056769&mibextid=kFxxJD" target="_blank"> 
  <img src={group3} alt='img'/>
      ...
      <div className="app-footer-div2">
        ...
        <div className="link-footer">
            <p onClick={() => scrollToSection('services')} style={{ cursor: 'pointer' }}>Services</p>
            <p onClick={() => scrollToSection('about-us')} style={{ cursor: 'pointer' }}>About Us</p>
            <p onClick={() => scrollToSection('contact-us')} style={{ cursor: 'pointer' }}>Contact Us</p>
            <p>Shipping</p>
        </div>
      </div>
  ...
  <div className="phone-num">
    <a href="mailto:eintransport.service@gmail.com" style={{ textDecoration: 'none', color: 'inherit' }}>
